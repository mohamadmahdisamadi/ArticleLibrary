...
public class AddArticlePage {
    ...
    public AddArticlePage() { service = new ArticleService(); }
    ...
    public byte[] getPage(Map<String, String> args) {
        ...
        htmlBuilder.append("    <title>Add New Article</title>\n");
        ...
        htmlBuilder.append("        }\n");
        htmlBuilder.append("        .message.isSuccess {\n");
        ...
        htmlBuilder.append("<h1>Add New Article</h1>\n");
        htmlBuilder.append("<div class=\"form-card\">\n");

        htmlBuilder.append("    <div id=\"message\" class=\"message\" style=\"display: none;\"></div>\n");

        htmlBuilder.append(String.format("    <form id=\"articleForm\" method=\"POST\" action=\"/%s\">\n", HttpEndpoints.AddArticleHandler));
        htmlBuilder.append("        <label>Title</label>\n");
        htmlBuilder.append("        <input type=\"text\" name=\"title\" required />\n");
        htmlBuilder.append("        <label>Summary</label>\n");
        htmlBuilder.append("        <textarea name=\"summary\" required></textarea>\n");
        htmlBuilder.append("        <label>Body</label>\n");
        htmlBuilder.append("        <textarea name=\"body\" required></textarea>\n");
        htmlBuilder.append("        <label>Citations (select related articles):</label>\n");
        htmlBuilder.append("        <div class=\"checkbox-list\">\n");
        for (ArticleEntity art : service.getAllArticles()) {
            ...
            htmlBuilder.append("                <input type=\"checkbox\" name=\"citations\" value=\"" + id + "\"> ");
            htmlBuilder.append(title);
            htmlBuilder.append("            </div>\n");
        }
        htmlBuilder.append("        </div>\n");
        htmlBuilder.append("        <button class=\"submit-btn\" type=\"submit\">Submit Article</button>\n");
        ...
        htmlBuilder.append("            });\n");
        htmlBuilder.append("            \n");
        htmlBuilder.append(String.format("fetch('/%s', {\n", HttpEndpoints.AddArticleHandler));
        ...
        htmlBuilder.append("                    messageEl.className = 'message isSuccess';\n");
        htmlBuilder.append("                    messageEl.textContent = 'Article added successfully!';\n");
        htmlBuilder.append("                    form.reset();\n");
        ...
        htmlBuilder.append("                var messageEl = document.getElementById('message');\n");
        htmlBuilder.append("                messageEl.className = 'message error';\n");
        htmlBuilder.append("                messageEl.textContent = 'Error submitting article: ' + error.message;\n");
        htmlBuilder.append("                messageEl.style.display = 'block';\n");
        htmlBuilder.append("            });\n");
        htmlBuilder.append("        });\n");
        htmlBuilder.append("    </script>\n");
